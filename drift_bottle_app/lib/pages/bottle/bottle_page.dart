      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            ...
            AppColors.starrySecondary.withOpacity(0.9),
            AppColors.starryBackground,
          ],
        ),
      ),
        ...
        children: [
          ...
          Positioned(
            ...
            child: Icon(
              Icons.star,
              size: 20.w,
              color: AppColors.starryAccent.withOpacity(0.6),
            ),
          ),
          Positioned(
            top: 80.h,
            ...
            child: Icon(
              Icons.star_outline,
              size: 16.w,
              color: AppColors.starryAccent.withOpacity(0.4),
            ),
          ),
          Positioned(
            top: 50.h,
            ...
            child: Icon(
              Icons.auto_awesome,
              size: 14.w,
              color: AppColors.starryAccent.withOpacity(0.5),
            ),
          ),
          // 主要内容
          Center(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [
                        AppColors.starryAccent.withOpacity(0.3),
                        AppColors.starryAccent.withOpacity(0.1),
                      ],
                    ),
                    border: Border.all(
                      color: AppColors.starryAccent.withOpacity(0.6),
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [
                            ...
                            AppColors.starryAccent.withOpacity(0.8),
                          ],
                        ),
                        boxShadow: [
                          BoxShadow(
  ...
  Widget _buildBottleItem(BottleModel bottle, int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppColors.starryCardBackground.withOpacity(0.9),
            AppColors.starryCardBackground.withOpacity(0.7),
          ],
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            AppColors.starryAccent.withOpacity(0.2),
                            AppColors.starryAccent.withOpacity(0.1),
                          ],
                        ),
        ...
        children: [
          Container(
            ...
            child: Icon(
              Icons.auto_awesome,
              size: 60.w,
              color: AppColors.starryAccent.withOpacity(0.7),
            ),
          ),
