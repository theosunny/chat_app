...
class _LoginPageState extends State<LoginPage>
  ...
  Future<void> _sendCode() async {
    ...
    try {
      ...
      final errorMessage = await authProvider.sendVerificationCode(_phoneController.text);
      ...
      if (errorMessage == null) {
        ...
        _showSnackBar('发送验证码失败: $errorMessage');
      }
    } catch (e) {
  ...
  Future<void> _login() async {
    ...
    try {
      final errorMessage = await authProvider.loginWithPhone(
      ...
      if (errorMessage == null) {
        ...
        _showSnackBar('登录失败: $errorMessage');
      }
    } catch (e) {
  ...
  Future<void> _loginWithWechat() async {
    // TODO: 实现微信SDK集成获取accessToken
    _showSnackBar('微信登录功能开发中，请使用手机号登录');
    return;
    
    // final authProvider = Provider.of<AuthProvider>(context, listen: false);
    // 
    // try {
    //   // 这里需要集成微信SDK获取accessToken
    //   final accessToken = await _getWechatAccessToken();
    //   if (accessToken == null) {
    //     _showSnackBar('获取微信授权失败');
    //     return;
    //   }
    //   
    //   final errorMessage = await authProvider.loginWithWechat(accessToken);
    //   
    //   if (errorMessage == null) {
    //     // 登录成功后初始化环信聊天服务
    //     final messageProvider = Provider.of<MessageProvider>(context, listen: false);
    ...
    //     }
    //   } else {
    //     _showSnackBar('微信登录失败: $errorMessage');
    //   }
    // } catch (e) {
  ...
  Future<void> _loginWithQQ() async {
    // TODO: 实现QQ SDK集成获取accessToken
    _showSnackBar('QQ登录功能开发中，请使用手机号登录');
    return;
    
    // final authProvider = Provider.of<AuthProvider>(context, listen: false);
    // 
    // try {
    //   // 这里需要集成QQ SDK获取accessToken
    //   final accessToken = await _getQQAccessToken();
    //   if (accessToken == null) {
    //     _showSnackBar('获取QQ授权失败');
    //     return;
    //   }
    //   
    //   final errorMessage = await authProvider.loginWithQQ(accessToken);
    //   
    //   if (errorMessage == null) {
    //     // 登录成功后初始化环信聊天服务
    //     final messageProvider = Provider.of<MessageProvider>(context, listen: false);
    ...
    //     }
    //   } else {
    //     _showSnackBar('QQ登录失败: $errorMessage');
    //   }
    // } catch (e) {
